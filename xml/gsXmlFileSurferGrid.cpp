...
static const tchar* elementNameDefault = SL( "FileSurferGridParameters" );

tinyxml2::XMLError write( const std::tstring& path, const gs::file::SurferGrid& param )
{
...
tinyxml2::XMLError read( gs::file::SurferGrid& param, const std::tstring& path )
{
...
tinyxml2::XMLElement* make_element( tinyxml2::XMLDocument& doc, const gs::file::SurferGrid& param, const std::tstring& elementName /*= SL( "" )*/ )
{
...
tinyxml2::XMLError from_handle( gs::file::SurferGrid& param, tinyxml2::XMLHandle handle )
{
...
tinyxml2::XMLError from_parent_handle( gs::file::SurferGrid& param, tinyxml2::XMLHandle hParent, const std::tstring& childName /*= SL( "" )*/ )
{
