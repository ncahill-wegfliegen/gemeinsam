...
static const tchar* elementNameDefault = SL( "FileGridInfoBlankParameters" );

tinyxml2::XMLError write( const std::tstring& path, const gs::file::GridInfoBlank& param )
{
...
tinyxml2::XMLError read( gs::file::GridInfoBlank& param, const std::tstring& path )
{
...
tinyxml2::XMLElement* make_element( tinyxml2::XMLDocument& doc, const gs::file::GridInfoBlank& param, const std::tstring& elementName /*= SL( "" )*/ )
{
    ...
    // No additional properties (just base class stuff)

    return element;
}

tinyxml2::XMLError from_handle( gs::file::GridInfoBlank& param, tinyxml2::XMLHandle handle )
{
...
tinyxml2::XMLError from_parent_handle( gs::file::GridInfoBlank& param, tinyxml2::XMLHandle hParent, const std::tstring& childName /*= SL( "" )*/ )
{
