...
template<> inline nhill::uwi::Format nhill::begin() { return uwi::Format::none; }
template<> inline nhill::uwi::Format nhill::end() { return to_enum<uwi::Format>( to_int(uwi::Format::full_dressed) + 1); }
#pragma endregion
