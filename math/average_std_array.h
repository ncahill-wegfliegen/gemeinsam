...
double arithmetic( const std::array<T,N>& x )
{
   return arithmetic( x.data(), N );
}
...
/// </remarks>
template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double arithmetic_sub( const std::array<T, N>& x, T x0 )
{
   return arithmetic_sub( x.data(), N, x0 );
}
...
/// </remarks>
template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double arithmetic_mult( const std::array<T, N>& x, T h )
{
   return arithmetic_mult( x.data(), N, h );
}
...
/// </remarks>
template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double arithmetic_grouped( const std::array<T, N>& x, const std::array<std::size_t, N>& n )
{
...
template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double arithmetic_weighted( const std::array<T, N>& x, const std::array<T, N>& w )
{
   return arithmetic_weighted( x.data(), w.data(), N );
}
...
template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double harmonic( const std::array<T, N>& x )
{
   return harmonic( x.data(), N );
}

template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double geometric( const std::array<T, N>& x )
{
   return geometric( x.data(), N );
}

template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double standard_deviation( const std::array<T, N>& x )
{
   standard_deviation( x.data(), N );
}

template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double standard_deviation( const std::array<T, N>& x, const std::array<T, N>& n )
{
   return standard_deviation( x.data(), n.data(), N );
}

template<std::size_t N, typename T, typename enable_if::is_math_type<T>* = nullptr>
double coeff_of_variation( const std::array<T, N>& x )
{
   return coeff_of_variation( x.data(), N );
}
